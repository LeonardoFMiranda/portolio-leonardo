...
export const Navbar = () => {
    ...
    return (
        ...
        >
            <div className="w-7/12 max-w-7xl flex justify-between items-center bg-surface/40 backdrop-blur-md border border-muted/50 px-8 py-4 rounded-full">
                ...
                <div className="hidden md:flex gap-8 text-sm font-medium text-lightGray">
                    <Link href="#home" className="hover:text-white transition-colors" onClick={handleScroll("#home")}>
                        Inicio
                    </Link>
