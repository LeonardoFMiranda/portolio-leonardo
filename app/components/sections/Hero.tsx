...
import { FadeIn } from "../ui/HeroFadein";
        ...
        <section className="relative min-h-screen flex flex-col justify-center items-center px-6 overflow-hidden" id="home">
            ...
            <FadeIn>
                <div className="z-10 text-center max-w-4xl">
                    <h1 className="font-display text-5xl md:text-8xl font-bold tracking-tighter text-white mb-6">
                        <span className="sr-only">MIRANDA CONSULTORIA</span>
                        <TypeText
                    ...
                    <p className="text-lightGray text-lg md:text-xl max-w-2xl mx-auto mb-10 font-sans">
                        I design and develop modern web applications, AI-powered tools, and scalable platforms.
                    </p>
